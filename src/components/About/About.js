              ...
              <div className="row">
                ...
                <div className="col-xs-7">
                  <div className="profile-info">
                    ...
                    <br />
                    <h5 className=""><strong>Blog : </strong><a href={"https://hmthanh.github.io/blog/"}>State of the art</a></h5>
                    <h2 className="profile-university"><strong>Language & tools</strong> :
                    <ul className="list-icon">
                        <li>
                          <img className="item-icon vsvim" alt="vsvim" src="./img/vsvim.png" />
                        </li>
                        <li>
                          <img className="item-icon" alt="python" src="./img/icon_python.png" />
                        </li>
                        <li>
                          <img className="item-icon" alt="cplusplus" src="./img/icon_cplusplus.png" />
                        </li>
                        <li>
                        ...
                        <li>
                          <img className="item-icon" alt="sql" src="./img/icon_sql.png" />
                        </li>
                        <li>
                          <img className="item-icon" alt="mysql" src="./img/icon_mysql.png" />
                        </li>
                        <li>
                          <img className="item-icon" alt="git" src="./img/icon_git.png" />
                        </li>
                        <li>
                          <img className="item-icon" alt="github" src="./img/icon_github.png" />
                        </li>
                      </ul>
                    </h2>
