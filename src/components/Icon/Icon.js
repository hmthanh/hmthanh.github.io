...
export class Facebook extends Component {
    render() {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 320 512">
                <path
...
export class ArrowAltCircleUp extends Component {
    render() {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" className="arrowcircle" viewBox="0 0 512 512">
                <path
...
export class HackerRank extends Component {
    render() {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 512 512">
...
export class Kaggle extends Component {
    render() {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 320 512">
